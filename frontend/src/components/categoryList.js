...
export const CategoryList = () => {
    ...
    // tao 1 duong link moi trong route frontend cho product page, categoryList la 1 component dieu huong trang theo san pham, 
    // duong link moi se dung params, va 1 treang nua la categoryPage hay j do de la cai params tren url 
